...
export const M2M_TRANSLATIONS = {
  // ── VaultAgent malware-forensics vocabulary ──
  'STATIC | RECEIVE_SMS+INTERNET | REQ_CODE:SmsRx': 'Static Analyst: the manifest pairs RECEIVE_SMS with INTERNET — a classic OTP-exfiltration combo. Requesting the SmsRx receiver code for the Reverse Engineer.',
  'REVERSE | FLAG_SMS_THEFT | FLAG_C2 | obf=false': 'Reverse Engineer: the SMS receiver forwards message bodies to a hardcoded server. Confirmed SMS/OTP theft with command-and-control exfiltration. No obfuscation.',
  'VERDICT | THREAT_HIGH | SMS-Stealer | FLAG_SMS_THEFT FLAG_C2 | ETA_10s': 'Chief Security Officer: final verdict — HIGH threat, SMS-Stealer family. Indicators: SMS theft and C2. Analysis completed in ~10 seconds.',
  // ── legacy infra vocabulary (kept for backward compatibility) ──
